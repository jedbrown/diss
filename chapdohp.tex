...
\begin{figure}
  ...
  \includegraphics[width=0.18\textwidth]{jscfigures/twist-visit-color}
  \includegraphics[width=0.8\textwidth]{jscfigures/random-visit-color}
...
\subsection{Stokes}\label{sec:jscstokes}
